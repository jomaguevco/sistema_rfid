...
### 🔔 Notificaciones (MediChat)
- **Bot de WhatsApp integrado** (MediChat) para:
  - Envío de recetas médicas con QR
  - Alertas de stock bajo y productos vencidos
  - Notificaciones a farmacéuticos y administradores
...
| **Químico Farmacéutico** | `quimico1` | `quimico123` |
| **Médico** | `medico_juan_perez` | `medico123` |

> 💡 Hay más usuarios disponibles: `quimico2-5` y otros médicos como `medico_carlos_ramirez`, `medico_diego_soto`, etc.
...
├── iniciar_todo.sh                   # Script de inicio macOS/Linux
├── detener.bat                       # Script de detención Windows
├── detener_todo.sh                   # Script de detención macOS/Linux
├── README.md                         # Esta documentación
│
└── ../medichat/                      # Bot de WhatsApp (proyecto hermano)
    ├── src/
    │   ├── app.js                    # Servidor principal
    │   ├── whatsapp.js               # Conexión WhatsApp
    │   └── rfidApi.js                # Cliente API Sistema RFID
    ├── qr/                           # QR de WhatsApp
    └── README.md                     # Documentación MediChat
```
